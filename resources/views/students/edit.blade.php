        ...
        <div class="col-md-9 col-lg-10 px-md-4">
            <div class="py-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h2 class="mb-0"><i class="bi bi-pencil"></i> Modifier un Élève</h2>
...
<form action="{{ route('students.update', $student) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="nom" name="nom" 
                                                   placeholder="Ex: Kouassi" value="{{ old('nom', $student->nom) }}"required>
                                        </div>

                                        <div class="col-md-6">
                                            <label for="prenom" class="form-label">Prénom(s) <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="prenom" name="prenom" 
                                                   placeholder="Ex: Jean Marie" value="{{ old('prenom', $student->prenom) }}" required>
                                        </div>

                                        <div class="col-md-6">
                                            <label for="date_naissance" class="form-label">Date de naissance <span class="text-danger">*</span></label>
                                            <input type="date" class="form-control" id="date_naissance" name="date_naissance" value="{{ old('date_naissance', $student->date_naissance->format('Y-m-d')) }}" required>
                                        </div>

                                        <div class="col-md-6">
                                            <label for="lieu_naissance" class="form-label">Lieu de naissance <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="lieu_naissance" name="lieu_naissance" 
                                                   placeholder="Ex: Cotonou" value="{{ old('lieu_naissance', $student->lieu_naissance) }}" required>
                                        </div>
    ...
    <option value="M" {{ old('genre', $student->genre) == 'M' ? 'selected' : '' }}>Masculin</option>
    <option value="F" {{ old('genre', $student->genre) == 'F' ? 'selected' : '' }}>Féminin</option>
</select>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="nationalite" name="nationalite" 
                                                   placeholder="Ex: Béninoise" value="{{ old('nationalite', $student->nationalite) }}" required>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" id="adresse" name="adresse" rows="2" 
                                                      placeholder="Ex: Quartier Akpakpa, Rue 123" required>{{ old('adresse', $student->adresse) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="matricule" name="matricule" 
                                                   placeholder="Auto-généré ou saisir" value="{{ old('matricule', $student->matricule) }}" required>
    ...
    @foreach($classes as $classe)
        <option value="{{ $classe->id }}" {{ old('classe_id', $student->classe_id) == $classe->id ? 'selected' : '' }}>
            {{ $classe->nom }}
        </option>
    @endforeach
</select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control" id="date_inscription" name="date_inscription" value="{{ old('date_inscription', $student->date_inscription) }}" required>
                                        </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="nom_parent" name="nom_parent" 
                                                   placeholder="Ex: Kouassi André" value="{{ old('nom_parent', $student->nom_parent) }}" required>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="tel" class="form-control" id="telephone_parent" name="telephone_parent" 
                                                   placeholder="Ex: +229 97 12 34 56" value="{{ old('telephone_parent', $student->telephone_parent) }}" required>
                                        </div>

                                        <div class="col-md-6">
                                            <label for="email_parent" class="form-label">Email</label>
                                            <input type="email" class="form-control" id="email_parent" name="email_parent" 
                                                   placeholder="Ex: parent@email.com" value="{{ old('email_parent', $student->email_parent) }}">
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" id="profession_parent" name="profession_parent" 
                                                   placeholder="Ex: Enseignant" value="{{ old('profession_parent', $student->profession_parent) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<small class="text-muted">Laisser vide pour conserver la photo actuelle</small>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="allergies" name="allergies" rows="2" 
                                                  placeholder="Aucune ou préciser...">{{ old('allergies', $student->allergies) }}</textarea>
                                    </div>

                                    <div class="mb-0">
                                        <label for="observations" class="form-label">Observations</label>
                                        <textarea class="form-control" id="observations" name="observations" rows="3" 
                                                  placeholder="Notes supplémentaires...">{{ old('observations', $student->observations) }}</textarea>
                                    </div>
                                </div>
                            </div>
    ...
    <i class="bi bi-save"></i> Mettre à jour l'élève
</button>
                                        <a href="/students" class="btn btn-outline-secondary">
